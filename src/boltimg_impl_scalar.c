...
SCALAR_TGT int conv_uint8_float32_norm_scalar(size_t w, size_t h, size_t c, uint8_t *restrict src, float *restrict dst)
{
...
SCALAR_TGT int conv_uint16_float32_norm_scalar(size_t w, size_t h, size_t c, uint16_t *restrict src, float *restrict dst)
{
  for (size_t idx = 0; idx < h * w * c; ++idx)
  {
