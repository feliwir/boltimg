...
SSE2_TGT static inline void conv_uint8_float32_norm_sse2_step(__m128i short_pack, __m128 *float_pack_low, __m128 *float_pack_high, __m128 scalar)
{
    // TODO:
}
...
SSE2_TGT static int conv_uint8_float32_norm_sse2_aligned(size_t w, size_t h, size_t c, uint8_t *restrict src, float *restrict dst)
{
    ...
    size_t idx = 0;
    for (; idx < (h * w * c - sizeof(__m128)); idx += sizeof(__m128))
    {
